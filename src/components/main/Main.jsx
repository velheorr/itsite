...
import {HStack, Text, Panel, Divider, Card} from 'rsuite';
import '../../css.scss'
...
const Main = () => {
    ...
    <div className="main-content">
		...
		<HStack gap={20} className='mb30' data-aos="zoom-in-up">
        ...
        <section className="section mt70 mb70" data-aos="fade-down">
			...
			<HStack style={{flexWrap: 'wrap', gap: '50px', justifyContent: 'center'}}>
				{techs.map((tech) => (
					<Card className="tech-card" key={tech.title} style={{maxWidth: '450px'}} shaded>
						<Card.Header>
							<HStack style={{justifyContent: 'flex-start', alignItems: 'center'}}>
								<img src={tech.img} alt={tech.title} className="tech-icon" />
								<Text size={'xl'}>{tech.title}</Text>
							</HStack>
						</Card.Header>
						<Card.Body>
							<Text size='md'>{tech.desc}</Text>
						</Card.Body>
					</Card>
				))}
			</HStack>
